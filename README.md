...
| [ai-usage-gnome](https://github.com/6K5EUQ/ai-usage-gnome) | GNOME Shell extension that shows Claude and Codex usage (5-hour and 7-day windows) in the top bar. |
...
![ArduPilot](https://img.shields.io/badge/ArduPilot-0B6E4F)
